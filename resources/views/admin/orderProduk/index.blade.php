  ...
  <section class="content">
    ...
    <div class="container-fluid">
      ...
      <form action="" method="GET">
        ...
        <div class="form-group">
          <a href="{{ route('laporan.exportPDFOrderProduk', ['start_date' => $start_date, 'end_date' => $end_date]) }}" class="btn btn-danger">PDF</a>
        </div>
        ...
        <div class="col-12">
          ...
          <div class="card">
              <div class="card-header">
                <a href="{{ route('orderProduk.create') }}" class="btn btn-success"><i class="fas fa-plus"></i> Create order</a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-sm table-striped" width="100%">
                  ...
                  <tr>
                    ...
                    <td>Rp. {{ number_format($order->net,3,'.','') }}</td>
                    <td>
                      @if ($order->gross != null)
                    ...
                    <td class="text-center">
                      <form action="{{ route('orderProduk.destroy', $order->id) }}" method="post">
                        @csrf
                        @method('delete')
                        <input type="hidden" name="loc">
                        <div class="d-flex flex-row bd-highlight mb-3">
                          @if($order->lunas != 'Approved')
                            <a href="{{ route('orderProduk.approve', $order->id) }}" class="mr-1 btn btn-success btn-sm">approve</a>
                          @endif
                          <a href="{{ route('orderProduk.show', $order->id) }}" class="mr-1 btn btn-info btn-sm">detail</a>
                          <a href="{{ route('orderProduk.edit', $order->id) }}" class="mr-1 btn btn-warning btn-sm">edit</a>
