...
@section('pendapatanBooking', 'active')
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Laporan Pendapatan Booking Service</h1>
  ...
  <section class="content">
    ...
    <div class="form-group">
      <a href="{{ route('laporan.exportPDFPendapatanBooking', ['start_date' => $start_date, 'end_date' => $end_date]) }}" class="btn btn-danger">PDF</a>
    </div>
        @if ($start_date && $end_date)
             <p>Data Pendapatan Booking dari {{ $start_date }} sampai dengan {{ $end_date }}</p>
        @endif
          ...
          <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-sm table-striped">
                  ...
                  <tbody>
                    @foreach($order_service as $items)
                  <tr>
