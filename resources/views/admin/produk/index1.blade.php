              ...
              <div class="card-body">
                <table id="example1" class="table table-sm table-striped">
                  ...
                  <tr>
                    ...
                    <td><a href="#" data-toggle="modal" data-target="#modal-default{{ $produk->id }}">
...
@if ($produk instanceof Illuminate\Database\Eloquent\Collection)
@foreach ($produk as $produk)
<div class="modal fade" id="modal-default{{ $produk[0]->id }}">
