              ...
              <div class="card-body">
                <form action="{{ route('produk.store') }}" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input name="name" type="text" value="{{ old('name') }}" required class="form-control" id="exampleInputEmail1" placeholder="Masukkan Nama Produk">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Deskripsi Singkat</label>
                    <input name="slug" type="text" value="{{ old('slug') }}" required class="form-control" id="exampleInputEmail1" placeholder="Masukkan Deskripsi Singkat">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Deskripsi</label>
                    <textarea class="form-control" required name="desc" value="{{ old('desc') }}" rows="5" placeholder="Masukkan Deskripsi Produk"></textarea>
                  </div>
                  <div class="form-group">
